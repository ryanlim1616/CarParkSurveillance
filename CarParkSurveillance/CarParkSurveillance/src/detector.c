...
#endif
bool predict_image(char *filename, float thresh);
...
{
	//printf("asdasdsasadasdasdasdasd 33 : %.6f\n", thresh);
	...
	/*predict_image("D:\\New folder\\20161018_182400.jpg", thresh);*/
}
///////////////////////////////////////////// Testing

bool predict_image(IplImage* input, float thresh) {
	//printf("asdasdsasadasdasdasdasd 33 : %5.6f\n", thresh);
	clock_t time;
	
	//input = cvLoadImage("Capture2.jpg", 3);

//	printf("hello: %i", input->depth);
	
	//for (int row = 0; row < input->height; row++)
	//{
	//	for (int col = 0; col < input->width; col++)
	//	{
	//		printf("%f, ", ((float*)(input->imageData + input->widthStep*row))[col]);
	//	}
	//	printf("\n");
	//}
...
int testing(char *filename) {
	int tempo;
	bool reValue = predict_image(filename, 0.1000);
